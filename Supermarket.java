...
public class Supermarket {
    ...
    public static void main(String[] args) {
        ...
        String correctCaptcha = "AIUEO"; // Captcha tetap untuk contoh
        ...
        do {
            ...
            if (username.equals("giva gusliana") && password.equals("21Agustus04") && inputCaptcha.equals(correctCaptcha)) {
        ...
        // Proses Transaksi
        System.out.println("\n+---------------------------------------------+");
        System.out.println("Selamat Datang di Supermarket Igip");
        System.out.println("+---------------------------------------------+");
        ...
        System.out.println("+---------------------------------------------+");
        System.out.println("Terima kasih telah berbelanja di Igip");
        System.out.println("+---------------------------------------------+");
